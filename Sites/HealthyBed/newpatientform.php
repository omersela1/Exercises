...
<?php
    ...
    $user = $_SESSION["usr"];
    $query = "SELECT * from tbl_217_users WHERE username='" .$user ."'";
...
<body>
    ...
    <div id="wrapper">
    <?php 
        echo '<h1>Bed # ' .$_GET["id"]. '</h1>
        <h2>Assign To New Patient</h2>
        <div id="bedFormContainer">
            <form action="admin.php?id=' .$_GET["id"]. '" class="addPatientForm" method="post">
                <input type="text" class="form-control" name="patientName" id="name" pattern="^[A-z]+ +[A-z]+" placeholder="Patient Name" value="">
                <input type="text" class="form-control" name="patientId" id="idnum" placeholder="ID #" value="">
                <input type="text" class="form-control" name="insurance" id="insurance" placeholder="Insurance Provider" value="">
                <label>Status: </label>
                <select name="status" class="form-control" aria-placeholder="Injury Status">
                    <option value="Stable">Stable</option>
                    <option value="Conscious, Unstable">Conscious, Unstable</option>
                    <option value="Sedated, Stable">Sedated, Stable</option>
                    <option value="Sedated, Unstable">Sedated, Unstable</option></select>
                    
                    <textarea name="description" class="form-control" rows="5" cols="15" placeholder="Optional: Injury description">No description</textarea>
                    <input type="submit" class="btn submitButton" value="Save changes">
            </form>
        </div>'
    ?>
    </div>
