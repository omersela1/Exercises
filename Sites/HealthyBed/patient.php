...
<body>
    ...
    <div id="wrapper">
        ...
        <?php
            $query = 'select * from tbl_217_patients where patient_id='.$_GET["id"];
            $result = mysqli_query($connection, $query);
            $row = mysqli_fetch_assoc($result);
            echo '<h2>Name: </h2><p>' .$row["f_name"]. ' ' .$row["l_name"]. '</p>
                <h2>ID: </h2><p>' .$row["real_id"]. ' </p>
                <h2>Insurance Provider: </h2><p>' .$row["insurance"]. ' </p>
                <h2>Status: </h2><p>' .$row["patient_status"]. ' </p>
                <h2>Description of Injury\Illness: </h2><p>' .$row["injury_description"]. ' </p><br>';
        ?>
